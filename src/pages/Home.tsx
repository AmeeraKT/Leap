...
function FeatureCard({
  ...
  return (
    <Link
      to={feature.to}
      className="group flex h-full flex-col rounded-2xl border border-border/60 bg-card p-4 text-foreground shadow-sm transition-transform hover:-translate-y-0.5 dark:border-border dark:bg-card dark:shadow-none md:p-5"
    >
...
function GamifiedRewardsSection() {
  return (
    <section className="overflow-x-hidden bg-background py-16 md:py-24">
